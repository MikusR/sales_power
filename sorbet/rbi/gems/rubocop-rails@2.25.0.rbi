...
#
# source://rubocop-rails//lib/rubocop/cop/rails/redundant_active_record_all_method.rb#9
module RuboCop::Cop::Rails::AllowedReceivers
  # @return [Boolean]
  #
  # source://rubocop-rails//lib/rubocop/cop/rails/redundant_active_record_all_method.rb#10
  def allowed_receiver?(receiver); end

  # source://rubocop-rails//lib/rubocop/cop/rails/redundant_active_record_all_method.rb#30
  def allowed_receivers; end

  # source://rubocop-rails//lib/rubocop/cop/rails/redundant_active_record_all_method.rb#16
...
class RuboCop::Cop::Rails::NotNullColumn < ::RuboCop::Cop::Base
  ...
  # source://rubocop-rails//lib/rubocop/cop/rails/not_null_column.rb#148
...
class RuboCop::Cop::Rails::Validation < ::RuboCop::Cop::Base
  ...
  # source://rubocop-rails//lib/rubocop/cop/rails/validation.rb#132
  ...
  # @return [Boolean]
  #
  # source://rubocop-rails//lib/rubocop/cop/rails/validation.rb#128
...
#   User.where('age > ?', 18)
#
# source://rubocop-rails//lib/rubocop/cop/rails/where_range.rb#29
class RuboCop::Cop::Rails::WhereRange < ::RuboCop::Cop::Base
  ...
  # source://rubocop-rails//lib/rubocop/cop/rails/where_range.rb#62
  def on_send(node); end

  # source://rubocop-rails//lib/rubocop/cop/rails/where_range.rb#55
  def where_range_call?(param0 = T.unsafe(nil)); end

  private

  # source://rubocop-rails//lib/rubocop/cop/rails/where_range.rb#145
  def build_good_method(method_name, column, value); end

  # source://rubocop-rails//lib/rubocop/cop/rails/where_range.rb#88
  def extract_column_and_value(template_node, values_node); end

  # source://rubocop-rails//lib/rubocop/cop/rails/where_range.rb#137
  def find_pair(hash_node, value); end

  # source://rubocop-rails//lib/rubocop/cop/rails/where_range.rb#141
  def offense_range(node); end

  # source://rubocop-rails//lib/rubocop/cop/rails/where_range.rb#133
  def range_operator(comparison_operator); end

  # @return [Boolean]
  #
  # source://rubocop-rails//lib/rubocop/cop/rails/where_range.rb#82
  def where_not?(node); end
end

# column >= ?
#
# source://rubocop-rails//lib/rubocop/cop/rails/where_range.rb#40
RuboCop::Cop::Rails::WhereRange::GTEQ_ANONYMOUS_RE = T.let(T.unsafe(nil), Regexp)

# column >= :value
#
# source://rubocop-rails//lib/rubocop/cop/rails/where_range.rb#46
RuboCop::Cop::Rails::WhereRange::GTEQ_NAMED_RE = T.let(T.unsafe(nil), Regexp)

# column <[=] ?
#
# source://rubocop-rails//lib/rubocop/cop/rails/where_range.rb#42
...
# source://rubocop-rails//lib/rubocop/cop/rails/where_range.rb#35
RuboCop::Cop::Rails::WhereRange::MSG = T.let(T.unsafe(nil), String)

# column >= ? AND column <[=] ?
#
# source://rubocop-rails//lib/rubocop/cop/rails/where_range.rb#44
...
class RuboCop::Cop::Style::InverseMethods < ::RuboCop::Cop::Base
  # source://rubocop/1.64.0/lib/rubocop/cop/style/inverse_methods.rb#70
  def inverse_block?(param0 = T.unsafe(nil)); end

  # source://rubocop/1.64.0/lib/rubocop/cop/style/inverse_methods.rb#61
  def inverse_candidate?(param0 = T.unsafe(nil)); end

  # source://rubocop/1.64.0/lib/rubocop/cop/style/inverse_methods.rb#92
  def on_block(node); end

  # source://rubocop/1.64.0/lib/rubocop/cop/style/inverse_methods.rb#78
  def on_csend(node); end
  ...
  # source://rubocop/1.64.0/lib/rubocop/cop/style/inverse_methods.rb#177
  def camel_case_constant?(node); end

  # source://rubocop/1.64.0/lib/rubocop/cop/style/inverse_methods.rb#121
  def correct_inverse_block(corrector, node); end

  # source://rubocop/1.64.0/lib/rubocop/cop/style/inverse_methods.rb#112
  def correct_inverse_method(corrector, node); end

  # source://rubocop/1.64.0/lib/rubocop/cop/style/inverse_methods.rb#128
  def correct_inverse_selector(block, corrector); end

  # source://rubocop/1.64.0/lib/rubocop/cop/style/inverse_methods.rb#181
  def dot_range(loc); end

  # source://rubocop/1.64.0/lib/rubocop/cop/style/inverse_methods.rb#166
  def end_parentheses(node, method_call); end

  # source://rubocop/1.64.0/lib/rubocop/cop/style/inverse_methods.rb#150
  def inverse_blocks; end

  # source://rubocop/1.64.0/lib/rubocop/cop/style/inverse_methods.rb#145
  def inverse_methods; end

  # source://rubocop/1.64.0/lib/rubocop/cop/style/inverse_methods.rb#191
  def message(method, inverse); end

  # source://rubocop/1.64.0/lib/rubocop/cop/style/inverse_methods.rb#154
  def negated?(node); end

  # source://rubocop/1.64.0/lib/rubocop/cop/style/inverse_methods.rb#162
  def not_to_receiver(node, method_call); end

  # source://rubocop/1.64.0/lib/rubocop/cop/style/inverse_methods.rb#172
  def possible_class_hierarchy_check?(lhs, rhs, method); end

  # source://rubocop/1.64.0/lib/rubocop/cop/style/inverse_methods.rb#158
  def relational_comparison_with_safe_navigation?(node); end

  # source://rubocop/1.64.0/lib/rubocop/cop/style/inverse_methods.rb#185
...
class RuboCop::Cop::Style::MethodCallWithArgsParentheses < ::RuboCop::Cop::Base
  # source://rubocop/1.64.0/lib/rubocop/cop/style/method_call_with_args_parentheses.rb#217
  def on_csend(node); end
  ...
  # source://rubocop/1.64.0/lib/rubocop/cop/style/method_call_with_args_parentheses.rb#225
  def args_begin(node); end

  # source://rubocop/1.64.0/lib/rubocop/cop/style/method_call_with_args_parentheses.rb#233
  def args_end(node); end

  # source://rubocop/1.64.0/lib/rubocop/cop/style/method_call_with_args_parentheses.rb#237
...
class RuboCop::Cop::Style::RedundantSelf < ::RuboCop::Cop::Base
  # source://rubocop/1.64.0/lib/rubocop/cop/style/redundant_self.rb#60
  def initialize(config = T.unsafe(nil), options = T.unsafe(nil)); end

  # source://rubocop/1.64.0/lib/rubocop/cop/style/redundant_self.rb#68
  def on_and_asgn(node); end

  # source://rubocop/1.64.0/lib/rubocop/cop/style/redundant_self.rb#86
  def on_args(node); end

  # source://rubocop/1.64.0/lib/rubocop/cop/style/redundant_self.rb#120
  def on_block(node); end

  # source://rubocop/1.64.0/lib/rubocop/cop/style/redundant_self.rb#90
  def on_blockarg(node); end

  # source://rubocop/1.64.0/lib/rubocop/cop/style/redundant_self.rb#81
  def on_def(node); end

  # source://rubocop/1.64.0/lib/rubocop/cop/style/redundant_self.rb#81
  def on_defs(node); end

  # source://rubocop/1.64.0/lib/rubocop/cop/style/redundant_self.rb#126
  def on_if(node); end

  # source://rubocop/1.64.0/lib/rubocop/cop/style/redundant_self.rb#104
  def on_in_pattern(node); end

  # source://rubocop/1.64.0/lib/rubocop/cop/style/redundant_self.rb#99
  def on_lvasgn(node); end

  # source://rubocop/1.64.0/lib/rubocop/cop/style/redundant_self.rb#94
  def on_masgn(node); end

  # source://rubocop/1.64.0/lib/rubocop/cop/style/redundant_self.rb#120
  def on_numblock(node); end

  # source://rubocop/1.64.0/lib/rubocop/cop/style/redundant_self.rb#74
  def on_op_asgn(node); end

  # source://rubocop/1.64.0/lib/rubocop/cop/style/redundant_self.rb#68
  def on_or_asgn(node); end

  # source://rubocop/1.64.0/lib/rubocop/cop/style/redundant_self.rb#108
  def on_send(node); end
  ...
  # source://rubocop/1.64.0/lib/rubocop/cop/style/redundant_self.rb#196
  def add_lhs_to_local_variables_scopes(rhs, lhs); end

  # source://rubocop/1.64.0/lib/rubocop/cop/style/redundant_self.rb#204
  def add_masgn_lhs_variables(rhs, lhs); end

  # source://rubocop/1.64.0/lib/rubocop/cop/style/redundant_self.rb#210
  def add_match_var_scopes(in_pattern_node); end

  # source://rubocop/1.64.0/lib/rubocop/cop/style/redundant_self.rb#144
  def add_scope(node, local_variables = T.unsafe(nil)); end

  # source://rubocop/1.64.0/lib/rubocop/cop/style/redundant_self.rb#190
  def allow_self(node); end

  # source://rubocop/1.64.0/lib/rubocop/cop/style/redundant_self.rb#150
  def allowed_send_node?(node); end

  # source://rubocop/1.64.0/lib/rubocop/cop/style/redundant_self.rb#165
  def it_method_in_block?(node); end

  # source://rubocop/1.64.0/lib/rubocop/cop/style/redundant_self.rb#181
  def on_argument(node); end

  # source://rubocop/1.64.0/lib/rubocop/cop/style/redundant_self.rb#173
